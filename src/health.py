...
потенциально совместимое со снижением крутильной жёсткости (ранний сигнал
изменения состояния, не доказанная деградация). Слой 2 извлекает медленный
дрейф из шума и поднимает тревогу с контролируемой частотой ложных срабатываний.
